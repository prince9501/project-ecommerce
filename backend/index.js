...
// mongoose.connect("mongodb+srv://jacobprinceka02:@Prince14022002@cluster0.ksdvzah.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0" , {
//   serverSelectionTimeoutMS: 30000, // 30 seconds
//   socketTimeoutMS: 45000, // 45 seconds
// });
...
//Creating API fr deleting Products
...
const fetchUser = async(req,res,next)=>{
    ...
    if (!token) {
        ...
        try {
            ...
            res.status(401).sed ({errors:"Please authenticate valid token"})
        }
    }
}
